 ...
 * Delete a chat
 */
export const deleteChatRouteApiDatasourcesChatsChatIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteChatRouteApiDatasourcesChatsChatIdDeleteData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<unknown, DeleteChatRouteApiDatasourcesChatsChatIdDeleteError, ThrowOnError>({
 ...
 * Get a chat
 */
export const getChatRouteApiDatasourcesChatsChatIdGet = <ThrowOnError extends boolean = false>(options: Options<GetChatRouteApiDatasourcesChatsChatIdGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetChatRouteApiDatasourcesChatsChatIdGetResponse, GetChatRouteApiDatasourcesChatsChatIdGetError, ThrowOnError>({
        url: '/api/datasources/chats/{chat_id}',
        ...options
    });
};
 ...
 * Update a chat title
 */
export const updateChatTitleRouteApiDatasourcesChatsChatIdPut = <ThrowOnError extends boolean = false>(options: Options<UpdateChatTitleRouteApiDatasourcesChatsChatIdPutData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).put<unknown, UpdateChatTitleRouteApiDatasourcesChatsChatIdPutError, ThrowOnError>({
        url: '/api/datasources/chats/{chat_id}',
        ...options
    });
};
 ...
 */
export const addMessageToChatRouteApiDatasourcesChatsChatIdMessagesPost = <ThrowOnError extends boolean = false>(options: Options<AddMessageToChatRouteApiDatasourcesChatsChatIdMessagesPostData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<AddMessageToChatRouteApiDatasourcesChatsChatIdMessagesPostResponse, AddMessageToChatRouteApiDatasourcesChatsChatIdMessagesPostError, ThrowOnError>({
