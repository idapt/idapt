 ...
 * Get all chats
 */
export const getAllChatsRouteApiDatasourcesChatsChatsGet = <ThrowOnError extends boolean = false>(options: Options<GetAllChatsRouteApiDatasourcesChatsChatsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllChatsRouteApiDatasourcesChatsChatsGetResponse, GetAllChatsRouteApiDatasourcesChatsChatsGetError, ThrowOnError>({
 ...
 * Create a chat
 */
export const createChatRouteApiDatasourcesChatsChatsPost = <ThrowOnError extends boolean = false>(options: Options<CreateChatRouteApiDatasourcesChatsChatsPostData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<CreateChatRouteApiDatasourcesChatsChatsPostResponse, CreateChatRouteApiDatasourcesChatsChatsPostError, ThrowOnError>({
        url: '/api/datasources/chats/chats',
        ...options
    });
};
 ...
 * Delete a chat
 */
export const deleteChatRouteApiDatasourcesChatsChatsChatIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteChatRouteApiDatasourcesChatsChatsChatIdDeleteData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<unknown, DeleteChatRouteApiDatasourcesChatsChatsChatIdDeleteError, ThrowOnError>({
 ...
 * Get a chat
 */
export const getChatRouteApiDatasourcesChatsChatsChatIdGet = <ThrowOnError extends boolean = false>(options: Options<GetChatRouteApiDatasourcesChatsChatsChatIdGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetChatRouteApiDatasourcesChatsChatsChatIdGetResponse, GetChatRouteApiDatasourcesChatsChatsChatIdGetError, ThrowOnError>({
        url: '/api/datasources/chats/chats/{chat_id}',
        ...options
    });
};
 ...
 * Update a chat title
 */
export const updateChatTitleRouteApiDatasourcesChatsChatsChatIdPut = <ThrowOnError extends boolean = false>(options: Options<UpdateChatTitleRouteApiDatasourcesChatsChatsChatIdPutData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).put<unknown, UpdateChatTitleRouteApiDatasourcesChatsChatsChatIdPutError, ThrowOnError>({
        url: '/api/datasources/chats/chats/{chat_id}',
        ...options
    });
};
 ...
 */
export const addMessageToChatRouteApiDatasourcesChatsChatsChatIdMessagesPost = <ThrowOnError extends boolean = false>(options: Options<AddMessageToChatRouteApiDatasourcesChatsChatsChatIdMessagesPostData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<AddMessageToChatRouteApiDatasourcesChatsChatsChatIdMessagesPostResponse, AddMessageToChatRouteApiDatasourcesChatsChatsChatIdMessagesPostError, ThrowOnError>({
